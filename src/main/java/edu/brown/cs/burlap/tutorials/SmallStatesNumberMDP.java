 ...
 */
public class SmallStatesNumberMDP {
...
//		gwdg.verticalWall(0, 2, 1);
		...
		initialState = new GridWorldState(new GridAgent(0, 0), new GridLocation(3, 3, "loc0"));
...
//		((QLearning) agent).setLearningPolicy(new RandomPolicy(domain));  // success rate = 1 -> numEpisodes = 18
	...
	public void simpleValueFunctionVis(ValueFunction valueFunction, Policy p){
		...
		ValueFunctionVisualizerGUI gui = GridWorldDomain.getGridWorldValueFunctionVisualization(allStates, 4, 4, valueFunction, p);
		gui.initGUI();
	}
	...
	public void manualValueFunctionVis(ValueFunction valueFunction, Policy p){
		...
		svp.setXYKeys("agent:x", "agent:y", new VariableDomain(0, 4), new VariableDomain(0, 4), 1, 1);
		...
		spp.setXYKeys("agent:x", "agent:y", new VariableDomain(0, 4), new VariableDomain(0, 4), 1, 1);
